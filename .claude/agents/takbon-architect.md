...
2. **정본은 역할별이다** — 설계 근거는 여기서 고른다:
   ...
   - `CLAUDE.md` 최상단 = 살아있는 함정·계약 · **`docs/DECISIONS.md` = 무엇을 왜 정했나**(세92 신설 — 방향을 뒤집는 설계를 내기 전에 **여기서 그 결정의 이유부터 읽어라**) · `docs/BACKLOG.md` = 아직 안 한 것 · `docs/PROGRESSION.md` = 관문 · `docs/takbon-design/` = 확정·대기 설계.
