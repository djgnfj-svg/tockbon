...
node: dopamine
stage: building
owns: [economy, progression, onboarding]
needs: []
blocked: 살아있는 계획(§9 룬 획득 통로)의 첫 턴인 보상 룬을 사용자가 큐레이션해야 한다(§온보딩 「사용자 확인 필요 지점」)
---
...
- ⚠ **이 갈래는 세57↔58에 이미 한 번 뒤집혔다가 여기서 또 뒤집힌 것이다** — 그래서 **혼자 정하면 안 되는 자리**다.
  살아있는 미결 = `docs/TODO.md` **「퀘스트 거짓 안내」**(온보딩 퀘스트가 은퇴한 「건설」을 아직 가르친다 · 사용자 결정 대기).
