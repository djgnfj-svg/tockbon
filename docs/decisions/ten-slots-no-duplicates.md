...
bison's hump had nowhere to attach.

## What wasn't chosen

| Rejected | Why |
|---|---|
| **Eight slots** (six external · two internal) | The original. A build ran out of room before it became a build |
| **Twelve slots** (five external · seven internal) | Too many to hold in the head. The user cut it while listing what each one would do — the list itself was the argument |
| **Nine, with no torso** | Left the body with head, back, limbs and tail and **no chest**. Half of what a beast's silhouette is made of had nowhere to go |
...
same day**: the body is a line and a worn part takes the host's colour, so nothing has to match
([the body is a line](the-body-is-a-line-drawn-by-code.md)). **Six still stands, on a different reason**:
six things sticking out of one small square is already as much as reads.

## What's tied to it

- **Bone carries the body's base force**, which is what `F` halves. Cut bone and splitting loses its material
