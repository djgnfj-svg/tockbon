...
The ladder starts at **beasts by habitat** (swamp, jungle, snow, deep sea, caves) and tops out at
**dinosaurs**, with a **final boss on a stage of its own**. Roughly ten minutes a stage, four to six stages.
...
| **One continuous world map** | A habitat is a field the size of the last one with a new palette and spawn table. Stitching them into a continent buys nothing and costs a map system |
| **A habitat of ordinary species only** | A bestiary, not a game. Every stage carries special individuals — a fantastical beast, a chimera, a mutant — and **which ones appear is rolled per stage** |
...
If ten minutes per habitat reads as padding, the length moves before the structure does. If machines are
wanted badly enough, the eating rule gets solved and human civilisation returns to the top of the ladder.
