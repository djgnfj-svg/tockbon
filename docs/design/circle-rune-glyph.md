Status: ⚠⚠ **틀이 죽었다.** 마법진 게임의 낱말 셋을 가른 문서이고 그 게임은 접혔다.

# 진 · 룬 · 문양 — 셋이 각각 무엇을 쥐나

**Status**: ⚠⚠ **아이디어로만 남는다 (2026-08-22 저녁, 사용자)** — 12월 기한이 서면서 컨셉이 서 있는
쪽이 이겼다. **지어지지 않는다. 그리고 안 지운다** (사용자가 그렇게 정했다).
⚠⚠ **그 뒤로 게임이 두 번 더 갈렸고, 지금 만드는 것과는 아무 관계가 없다** — 지금은 **사람 회사가 섬
하나를 지키고 짐승이 배로 쳐들어오는 게임**이다. 마법도 탑도 발사체도 없다.
⇒ **여기서 읽을 것은 마법진이 아니라 자르는 법이다**: 하나로 뭉친 것을 **시간으로 셋으로 자르면 셋이
서로를 안 잡아먹는다.** 그 유도는 무엇이 나가든 성립한다. 이 문서는 그것 하나 때문에 산다.
...
- ⚠⚠ **2026-08-22에 새로 열린 것: 진이 어디에 들어가나.** 사용자 — *"무기마다 마법진을 넣고 장비에도
  ...
  **진의 개수와 성격이 장비 슬롯 수에 묶이고**, 위의 「진 셋」이 그대로 서는지 다시 봐야 한다
  - ⇒ **같은 날 사용자가 이 문서를 다시 읽고 바로잡았다**: *"진은 하나로 고정이야."* **진은 한 번에
    하나만 착용한다.** 위의 「진 셋」은 그대로 선다. **개수는 답이 났고, 남은 것은 진이 어디에 달려
    있나와 한 판 안에서 바뀌나다** — 지도의 티켓 02가 들고 있다
