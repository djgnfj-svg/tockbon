...
**세포 군대 로그라이크다.** ⚠ **이 폴더에 그 문서가 하나도 없다** — 세포 GDD와 접은 갈래 여덟은
2026-08-22 아침에 게임과 함께 나갔고 커밋 `62ff57d`에 있다. **저녁에 세포로 돌아왔지만 문서는 아직
안 되살렸다.** ⇒ **무엇을 만드는가는 지금 `.scratch/cell-hook/`에서 읽는다.**
