...
# ------------------------------------------------------------------ 램프
# 🔴 세91 팔레트 확장분(TAKBON 60)에서 얻은 것: 따뜻한 최암부 2e1f18(붉은 계열 윤곽) ·
#    어두운 무채 2a2c32/4e5259(금속·장화) · 숲 최암 16281c · 밝은 흰 f7f7f2(마법 코어) ·
#    보라 8b5fbf/e0a3e8(마법사 자수) · 황토 c9962e·쨍노랑 f2cb3f(금박).
